...
class KunenaMessage extends KunenaDatabaseObject
{
    ...
    public function newReply($fields = [], $useridfromparent = 0, $safefields = null): array
    {
        ...
        // TreeK patch v1.0: topic subject must never be changed by a reply post.
        // The topic subject is determined when the first post in the topic is created
        // and remains fixed once that post has been sent.
        // Original code allowed any reply by topic author or moderator to overwrite
        // the topic subject, which is incorrect behaviour.
