...
<form action="<?php echo KunenaRoute::_('index.php?option=com_kunena') ?>" method="post" class="form-validate" role="form" id="postform" name="postform" enctype="multipart/form-data" data-page-identifier="1">
    ...
    <?php
    // TreeK patch v1.0: hidden subject input removed.
    // topic->subject is no longer updated from frontend replies.
    // Cancelled: if (!$this->config->allowChangeSubject)
    ?>
    ...
    <div class="shadow-lg p-3 mb-5 rounded">
        ...
        <div class="form-group row">
            <label for="subject" class="col-sm-2 col-form-label">
                ...
                <?php if ($isReplyForm) : ?>
                    <a href="#"
                       ...
                       data-treek-icon-one="<?php echo Text::_('COM_KUNENA_TREEK_ARROW_CANCEL_ONE'); ?>"
                       data-treek-icon-off="<?php echo Text::_('COM_KUNENA_TREEK_ARROW_SUFFIX_OFF'); ?>"
                       data-treek-tip-cancel="<?php echo Text::_('COM_KUNENA_TREEK_CANCEL_SUFFIX_TOOLTIP'); ?>"
                       data-treek-tip-one="<?php echo Text::_('COM_KUNENA_TREEK_CANCEL_ONE_TOOLTIP'); ?>"
                       data-treek-tip-off="<?php echo Text::_('COM_KUNENA_TREEK_SUFFIX_OFF_TOOLTIP'); ?>"
                       data-bs-toggle="tooltip"
                       title="<?php echo Text::_('COM_KUNENA_TREEK_CANCEL_SUFFIX_TOOLTIP'); ?>"
            ...
            <div class="col-md-10">
                ...
                ?>
                    <input class="form-control treek-subject-field" type="text" name="subject" id="subject"
    ...
    <?php if ($this->message->exists() && $this->config->editMarkup) : ?>
        <h2><?php echo Text::_('COM_KUNENA_EDITING_REASON') ?></h2>
        <div class="shadow-lg pl-5 pt-3 pb-1 mb-5 rounded">
            <div class="form-group row" id="modified-reason">
                <div class="col-md-10">
                    <input class="form-control" name="modified_reason" maxlength="200" type="text"
                        value="<?php echo $this->modified_reason; ?>"
                        data-bs-toggle="tooltip" title="<?php echo Text::_('COM_KUNENA_EDITING_ENTER_REASON') ?>"
    ...
    <?php if ($this->allowedExtensions && $this->UserCanPostImage) : ?>
        <h2><?php echo Text::_('COM_KUNENA_EDITOR_ATTACHMENTS'); ?></h2>
    ...
    <?php if ($this->canSubscribe) : ?>
        <h2><?php echo Text::_('COM_KUNENA_POST_SUBSCRIBE'); ?></h2>
        <div class="shadow-lg p-3 mb-5 rounded">
    ...
    <?php if ($this->message->userid && $this->message->getCategory()->allowAnonymous) : ?>
        <h2><?php echo Text::_('COM_KUNENA_POST_AS_ANONYMOUS'); ?></h2>
        <div class="shadow-lg p-3 mb-5 rounded">
