...
$this->headerText = Text::sprintf('COM_KUNENA_REPLYTO_HEADER_TREEK',
    ...
    $parent->subject);
$this->headerTextPlain = Text::sprintf('COM_KUNENA_REPLYTO_HEADER_TREEK',
    $parent->getAuthor()->getName(),
    $parent->subject);
    ...
    protected function prepareDocument()
    {
        ...
        if ($menu_item) {
            ...
            if (!empty($params_title)) {
                ...
                $this->setTitle($this->headerTextPlain);
            }
            ...
            if (!empty($params_description)) {
                ...
                $this->setDescription($this->headerTextPlain);
            }
        }
    }
}
