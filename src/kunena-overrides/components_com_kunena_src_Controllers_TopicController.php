...
class TopicController extends KunenaController
{
    ...
    public function edit()
    {
        ...
        // Cancelled: Check if we are editing first post and update topic if we are!
        // TreeK patch v1.0: topic subject is immutable after topic creation.
        // It is never updated from the frontend, including when editing the first post.
